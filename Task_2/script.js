class Logo {
  ...
  class Circle{
    ...
    createTemplate(){
      return`
        <div style="width:${this.size}px; height:${this.size}px; background-color: ${this.color}; border-radius: ${this.size}px; position: absolute;  top: 40px;  left: 50px;"></div>
      `
    }
  ...
  let mfCircle = new Circle(70, 'red');
  mfCircle.render();
